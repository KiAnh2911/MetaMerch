...
// 
$('.danhsachsanpham .wrp .trangphuc').on('click', '.dong', function () {
    $(this).parent().find('.hienthi').toggleClass('active');
    $(this).toggleClass('active');
});
$('.danhsachsanpham .wrp .bot_dssp .right .top_ctbv .list ').on('click', '.top_list', function () {
    $(this).parent().find('.bot_list').toggleClass('active');
    $(this).toggleClass('active');
});
//
$('.congnghe .wrp .group .col_2 .tab').on("click",function(){
    var val = $(this).attr("data")
   if( $(this).hasClass(".active")) return;
   $(".congnghe .wrp .group .col_2 .tab").removeClass("active")
   $(".congnghe .wrp .group .col .box").removeClass("active")
   $(this).addClass("active");
   $(val).addClass("active");
});
//
$('.ctsp2 .wrp .left .top .title').on("click",function(){
    var val = $(this).attr("data")
   if( $(this).hasClass(".active")) return;
   $(".ctsp2 .wrp .left .top .title").removeClass("active")
   $(".ctsp2 .wrp .left .bot .desc").removeClass("active")
   $(this).addClass("active");
   $(val).addClass("active");
});
// 
$('.ctsp .wrp .right .box_ctsp .grp_mau .mau').on('click', function () {
    if( $(this).hasClass(".active")) return;
    $('.ctsp .wrp .right .box_ctsp .grp_mau .mau').removeClass('active');
    $(this).toggleClass('active');
});
